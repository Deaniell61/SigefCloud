...
function getProperty($var){
  ...
  if($var == 'key') Return 'Sa7AXIjgSMhI99I4';
	if($var == 'password') Return '0DvFWK6a94ds13CBMuxqpcrXG';
//	if($var == 'password') Return 'AqzpGsomftGdiPsaMHsIGLcSq';
	if($var == 'parentkey') Return 'Sa7AXIjgSMhI99I4';
	if($var == 'parentpassword') Return '0DvFWK6a94ds13CBMuxqpcrXG';
//	if($var == 'parentpassword') Return 'AqzpGsomftGdiPsaMHsIGLcSq';
