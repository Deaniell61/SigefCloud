...
$codprov=strtolower($_SESSION['codprov']);
...
$pref=strtolower("../../imagenes/proveedores/".limpiar_caracteres_especiales($_SESSION['nomProv'])."/");
$prefc=strtolower("../../imagenes/proveedores/cache/".limpiar_caracteres_especiales($_SESSION['nomProv'])."/");
$ret="";
//sleep(2);
	switch($cara)
	{
