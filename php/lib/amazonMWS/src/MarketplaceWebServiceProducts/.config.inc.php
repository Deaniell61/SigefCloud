<?php
    ...
    * http://aws.amazon.com
    ***********************************************************************/
    define('AWS_ACCESS_KEY_ID', 'AKIAJKL7MV53M3E465KA');
    define('AWS_SECRET_ACCESS_KEY', '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');
    ...
    ***********************************************************************/
    define('APPLICATION_NAME', 'sigefMWS');
    ...
    * marketplace ID.
    ***********************************************************************/
    define ('MERCHANT_ID', 'A1PVVE9GY28O4X');
    ...
    ***********************************************************************/
    set_include_path(get_include_path() . PATH_SEPARATOR . $_SERVER["DOCUMENT_ROOT"] . "/php/lib/amazonMWS/src");
   /************************************************************************
    * OPTIONAL ON SOME INSTALLATIONS
    *
