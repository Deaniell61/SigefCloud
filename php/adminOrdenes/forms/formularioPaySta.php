...
?>
    <script>
        ...
        function buscar() {
            ...
            $.ajax({
               url: '../php/adminOrdenes/tablas/llenarPaySta.php',
                type: 'POST',
                data: 'nombre=' + nombre,
    ...
    <aside>
        ...
        <table>
            <tr>
               ...
               <td>
                    <div class="">
                        <input class='cmd button button-highlight button-pill' type="button" onClick="abrirAdminOrder('PaySta','');" value="<?php echo $lang[$idioma]['Nuevo']?>" />
                    </div>
                </td>
            </tr>
