...
?>
    <script>
        ...
        function buscar() {
            ...
            $.ajax({
               url: '../php/adminOrdenes/tablas/llenarShiCarrier.php',
                type: 'POST',
                data: 'nombre=' + nombre,
    ...
    <center>
        <?php echo $lang[$idioma]['shicarrier'];?>
    </center>
    <aside>
        ...
        <table>
            <tr>
               ...
               <td>
                    <div class="">
                        <input class='cmd button button-highlight button-pill' type="button" onClick="abrirAdminOrder('ShiCarrier','');" value="<?php echo $lang[$idioma]['Nuevo']?>" />
                    </div>
                </td>
            </tr>
