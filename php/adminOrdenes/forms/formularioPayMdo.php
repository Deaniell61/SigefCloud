...
?>
    <script>
        ...
        function buscar() {
            ...
            $.ajax({
               url: '../php/adminOrdenes/tablas/llenarPayMdo.php',
                type: 'POST',
                data: 'nombre=' + nombre,
    ...
    <aside>
        ...
        <table>
            <tr>
               ...
               <td>
                    <div class="">
                        <input class='cmd button button-highlight button-pill' type="button" onClick="abrirAdminOrder('PayMdo','');" value="<?php echo $lang[$idioma]['Nuevo']?>" />
                    </div>
                </td>
            </tr>
