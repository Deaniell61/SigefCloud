...
<form id="formAux" action="return false" onSubmit="return false" method="POST">
      ...
      <div class="tituloCatalogo">
         ...
         <center>
    	 <strong>
    	  &nbsp;&nbsp;<?php echo $lang[ $idioma ]['catordsta']; ?>
    	 </strong></center>
			</div>
      <br>
        <table>
                ...
                <tr hidden>
            	<td class="text"><span><?php echo $lang[$idioma]['ordsta'];?></span></td>
            ...
            <td colspan="2">
            <input type="button"  class='cmd button button-highlight button-pill'  onClick="ingresoAux('ordSta');setTimeout(cerrar,2000);" value="<?php echo $lang[$idioma]['Guardar'];?>"/>
