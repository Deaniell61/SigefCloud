...
<form id="formAux" action="return false" onSubmit="return false" method="POST">
      ...
      <div class="tituloCatalogo">
    	 <br>
    	 <strong>
    	  &nbsp;&nbsp;<?php echo $lang[ $idioma ]['catpaysta']; ?>
    	 </strong>
			</div>
      <br>
        <table>
                ...
                <tr hidden>
            	<td class="text"><span><?php echo $lang[$idioma]['paysta'];?></span></td>
            ...
            <td colspan="2">
            <input type="button"  class='cmd button button-highlight button-pill'  onClick="ingresoAux('paySta');setTimeout(cerrar,2000);" value="<?php echo $lang[$idioma]['Guardar'];?>"/>
