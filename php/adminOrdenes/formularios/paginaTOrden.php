...
<form id="formAux" action="return false" onSubmit="return false" method="POST">
      ...
      <div class="tituloCatalogo">
    	 <br>
    	 <strong>
    	  &nbsp;&nbsp;<?php echo $lang[ $idioma ]['cattorden']; ?>
    	 </strong>
			</div>
      <br>
        <table>
        	...
        	<tr>
            	<td class="text"><span><?php echo $lang[$idioma]['torden'];?></span></td>
            ...
            <td colspan="2">
            <input type="button"  class='cmd button button-highlight button-pill'  onClick="ingresoAux('tOrden');setTimeout(cerrar,2000);" value="<?php echo $lang[$idioma]['Guardar'];?>"/>
