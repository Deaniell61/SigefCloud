...
function buscar()
{
	...
	$.ajax({
			url:'../php/notificaciones/llenarNotificacion.php',
			type:'POST',
...
<center><?php echo $lang[$idioma]['notificaciones'];?></center>
<aside><div id="resultado"></div>
            ...
            <tr><td><br></td></tr>
            	<tr>
                    ...
                    <td><div class=""><input  class='cmd button button-highlight button-pill' type="button" onClick="abrirNotificacion('',paisGlobal,codPaisGlobal);" value="<?php echo $lang[$idioma]['Nuevo']?>"/></div>
                    </td>
                </tr>
