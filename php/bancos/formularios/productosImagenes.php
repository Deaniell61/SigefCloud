      ...
      <br>
        <table>
            ...
            <tr>
                ...
                <td colspan="2"><input type="text" class='entradaTexto' name="prodName" disabled id="prodName" value="<?php echo $row['prodName'];?>"></td>
                    ...
                    <td class="text"><span><?php echo $lang[$idioma]['ImagenCara'];?></span></td>
                       ...
                       <input disabled type="file" style="float:left; margin-left:15px;"  class='entradaTexto'name="archivo" id="archivo" onChange="subirArchivos();" /><progress id="barra_de_progreso" style="float:left; margin-left:10px; height:20px;" value="0" max="100"></progress></td></tr>
                    <!--<tr><td></td>
            <td colspan="4" style="text-align:center;"><input type="checkbox" id="terminos" onChange="terminosCons('<?php #echo $_SESSION['codprod'];?>','<?php #echo $_SESSION['user'];?>','<?php #echo $_SESSION['codEmpresa'];?>',this.check,'<?php #echo $_SESSION['pais'];?>');"> Acepto los <a href="#" onClick="">Terminos y Condiciones del Servicio</a>  </td></tr> -->  
                   ...
                   <br>
                    	<div id="contenidos" >
        					<div id="lupa" hidden="" ><img  id="im" src="" width="1000px" style="display:inline-block;"   /></div><img id="im0" onmouseover="document.getElementById('lupa').hidden = false;Lupa();" onmouseleave="document.getElementById('lupa').hidden = true;" src="" width="450px"  height="450px" />
    					</div>
