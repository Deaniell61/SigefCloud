...
{
	$squery="select orderid, timoford, grandtotal, orderunits, ordsou, tranum,codorden,shifee,shicar,firstname,lastname,shipcity,shipstate from tra_ord_enc where orderid='".$codigo."'";
