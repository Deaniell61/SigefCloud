...
$codigo = $_SESSION['codPais'] = $_GET['cod'];
$cont = $_GET['con'];
$ultimo = $_GET['ul'];
?>
<!doctype html>
            ...
            <form id="notificacion" name="notificacion" action="return false" onSubmit="return false" method="POST">
                <center>
                    <table>
                        <tr>
                            <td colspan="4"><strong>
                                    <center><?php echo $lang[$idioma]['Order'] ?></center>
                                </strong></td>

                        </tr>
                        <tr hidden>
                            <td colspan="4">
                                <center><img src="../../images/iconosSeller/Channel_Local_Store.png" id="logoLocation"
                                             style="width:20px; height:20px;"/></center>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="1">
                                <strong>
                                    <div class='entradaTexto textoGrande' id="Nombre"
                            ...
                            <td colspan="1">
                                <strong>
                                    <div class='entradaTexto textoGrande' id="Estado"
                                         style="text-align:left; padding-left:10px;"></div>
                                </strong>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="1">
                                <strong>
                                    <div class='entradaTexto textoGrande' id="numeroOrden"
                                         style="text-align:left; padding-left:10px;">
                                        <?php
                                        if ($cont > 0) {
                                            ?>
                                            <img width="20px" height="20px" style="margin-right:10%; cursor:pointer;"
                                                 src="../../images/anterior.png"
                                                 onClick="cambiarOrden('2','<?php echo $cont; ?>','<?php echo $pais; ?>','<?php echo $codigo; ?>','<?php echo $ultimo; ?>')"
                                                 title="Anterior">
                                        <?php } ?>
                                        <span id="enMedio"></span>
                                        <?php
                                        if ($cont < $ultimo) {
                                            ?>
                                            <img width="20px" height="20px" style="margin-left:10%; cursor:pointer;"
                                                 src="../../images/proximo.png"
                                                 onClick="cambiarOrden('1','<?php echo $cont; ?>','<?php echo $pais; ?>','<?php echo $codigo; ?>','<?php echo $ultimo; ?>')"
                                                 title="Siguiente">
                                        <?php } ?>
                                    </div>
                                </strong>
                            ...
                            <td colspan="1">
                                <strong>
                                    <div class='entradaTexto textoGrande' id="numeroTraking"
                                         style="text-align:left; padding-left:10px;"></div>
                                </strong>
                            </td>
                        ...
                        <tr>
                            <td colspan="4"><input type="text" class='entradaTexto' hidden="hidden" name="codigo"
                                                   id="codigo" value="" disabled/></td>
                        </tr>
                        <tr hidden>
                        ...
                        <tr>
                            ...
                            <td style="padding-bottom:5px;"><input type="text" class='entradaTexto textoGrande'
                                                                   id="timoford" disabled></td>
                            <td class="text">Salida de bodega</td>
                            <td>
                                <div class='entradaTexto textoGrande' id="numeroCheque"
                                     style="text-align:left; padding-left:10px;"></div>
                            </td>
                    ...
                    <center>
                        <div>
                            ...
                            <div id="totalOrden" style="float: right;margin-right: 20%;text-align: right;"></div>
                            <div id="totalTituOrden"
                                 style="float: right;margin-right: 2%;text-align: left;"><?php echo $lang[$idioma]['SubTotal']; ?>
                                <br><?php echo $lang[$idioma]['shipping']; ?>
                                <br><?php echo $lang[$idioma]['grandtotal']; ?></div>
