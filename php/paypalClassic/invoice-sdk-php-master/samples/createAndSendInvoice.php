...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    */
    ...
    if(($_POST['accessToken']!= null) && ($_POST['tokenSecret'] != null)) {
        $cred = new PPSignatureCredential("paulo.armas-facilitator@coexport.net", "VSNBMWW4MJ37WD5E", "ABUxXLUdsaD1wJ70X8FYh2HsO4M4AMOS3S8aragZjxk4t69Np5mEzQuV");
    ...
    echo "</table>";
    echo $_POST['accessToken'] . "!<br>";
    echo $_POST['tokenSecret'] . "!<br>";
    ...
    <form method="POST">
        ...
        <div class="params">
            ...
            <div class="param_value"><input type="text" name="merchantEmail"
                                            value="paulo.armas-facilitator@coexport.net" size="50" maxlength="260" /></div>
            <div class="param_name">Payer Email</div>
            <div class="param_value"><input type="text" name="payerEmail"
                                            value="paulo.armas-buyer@coexport.net" size="50" maxlength="260" /></div>
