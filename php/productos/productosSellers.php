...
<script>formularioSellers('<?php echo $_SESSION['codEmpresa'];?>','<?php echo $_SESSION['pais'];?>','<?php echo $_SESSION['codprod'];?>');
setTimeout(function(){$("#cargaLoad").dialog("close");},500);
</script>

<div id="productos">

<script>seleccion(document.getElementById('TabSellers'));</script>
<form id="ProductosGeneral" action="return false" onSubmit="return false" method="POST">
      ...
      <br>
        <table>
            ...
            <td colspan='4'>
            <input type="button" class='cmd button button-highlight button-pill' onClick="setTimeout(function(){ventana('cargaLoad',300,400);producto(11,'<?php echo $_SESSION['codEmpresa'];?>','<?php echo $_SESSION['pais'];?>','<?php echo $_SESSION['codprod'];?>');},1000);" value="<?php echo $lang[$idioma]['Guardar'];?>"/>
