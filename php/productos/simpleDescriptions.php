                ...
                <center>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><textarea style="height: 40px" class='entradaTexto' id="keyWords"
                                                      onKeyUp="verificaImportantes('MetaData','guardar23');"
                                                      rows="7" maxlength="250"><?php echo $row['keywords']; ?></textarea>
                                <div id="caracteresKeyWords" class="caracteres">Palabras y/o frases separadas por coma (,), no usar ( ' )</div>
<!--                                <div id="caracteresKeyWords" class="caracteres"></div>-->
                        ...
                        <tr>
                            <td class="text"><span><?php echo $lang[$idioma]['ProdDesc']; ?><span
                                            class="validaraster">*</span></span></td>
                            <td colspan="2"><textarea style="height: 150px" class='entradaTexto' id="prodDesc"
                                                      onKeyUp="verificaImportantes('MetaData','guardar23');"
                                                      rows="8" maxlength="4000"><?php echo str_replace('@amp;','&',str_replace('"','\"',str_replace("\n","",$row['descprod']))); ?></textarea>
                        ...
                        <tr hidden>
                            ...
                            <td colspan="2"><textarea class='entradaTexto' id="prodDescH"
                                                      onKeyUp="verificaImportantes('MetaData','guardar23');"
                                                      rows="8" maxlength="1000"><?php echo str_replace('@amp;','&',str_replace('"','\"',str_replace("\n","",$row['descprod']))); ?></textarea>
                                <div id="caracteresProdDesc" class="caracteres"></div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2"><textarea class='entradaTexto' id="prodDescShort"
                                                      onKeyUp="contarCaracteres(this,80,document.getElementById('caracteresShortProdDesc'));verificaImportantes('MetaData','guardar23');"
                                                      rows="7" maxlength="80"><?php echo ((($row['descshort']))); ?></textarea>
                                <div id="caracteresShortProdDesc" class="caracteres">80</div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="2"><textarea class='entradaTexto' id="prodDescShort1"
                                                      onKeyUp="contarCaracteres(this,80,document.getElementById('caracteresShortProdDesc1'));verificaImportantes('MetaData','guardar23');"
                                                      rows="7" maxlength="80"><?php echo ((($row['descshor1']))); ?></textarea>
                                <div id="caracteresShortProdDesc1" class="caracteres">80</div>
                            </td>
                        </tr>
                        <tr>
                            <td class="text"><span><span
                            ...
                            <td colspan="2"><textarea class='entradaTexto' id="prodDescShort2"
                                                      onKeyUp="contarCaracteres(this,80,document.getElementById('caracteresShortProdDesc2'));verificaImportantes('MetaData','guardar23');"
                                                      rows="7" maxlength="80"><?php echo ((($row['descshor2']))); ?></textarea>
                                <div id="caracteresShortProdDesc2" class="caracteres">80</div>
                            </td>
                        </tr>
                        <tr>
                            <td class="text"><span><span
                            ...
                            <td colspan="2"><textarea class='entradaTexto' id="prodDescShort3"
                                                      onKeyUp="contarCaracteres(this,80,document.getElementById('caracteresShortProdDesc3'));verificaImportantes('MetaData','guardar23');"
                                                      rows="7" maxlength="80"><?php echo ((($row['descshor3']))); ?></textarea>
                                <div id="caracteresShortProdDesc3" class="caracteres">80</div>
                            </td>
                        </tr>
                        <tr>
                            <td class="text"><span><span
                            ...
                            <td colspan="2"><textarea class='entradaTexto' id="prodDescShort4"
                                                      onKeyUp="contarCaracteres(this,80,document.getElementById('caracteresShortProdDesc4'));verificaImportantes('MetaData','guardar23');"
                                                      rows="7"><?php echo ((($row['descshor4']))); ?></textarea>
                                <div id="caracteresShortProdDesc4" class="caracteres">80</div>
                            </td>
                        </tr>
                        <tr>
