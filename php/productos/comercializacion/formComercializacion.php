...
<aside><div id="resultado"></div>
        ...
        <table>
         ...
         <input type="button" class='cmd button button-highlight button-pill' value="<?php echo $lang[$idioma]['Generarxsl'];?>" onClick="llamarReporte(8,document.getElementById('canal'));">  
         ...
         <input type="button" class='cmd button button-highlight button-pill' value="<?php echo $lang[$idioma]['Generartxt'];?>" onClick="llamarReporte(5,document.getElementById('canal'));">  
          ...
          <input type="button" class='cmd button button-highlight button-pill' value="<?php echo $lang[$idioma]['Generarcsv'];?>" onClick="llamarReporte(6,document.getElementById('canal'));"> <br>
          <input type="button" class='cmd button button-highlight button-pill' value="AppEagle" onClick="llamarReporte(18,document.getElementById('canal'));"> 
