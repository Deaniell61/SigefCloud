				...
				$("#archivo").upload('subir_archivo.php',
					{
						...
						nombre_archivo3: $('#codigos').html(),
						nombre_archivo4: $('#competencia option:selected').html()+"_"+$('#unidades').val()
...
function mostrarArchivos()
			{
				...
				$.ajax({
					url:'mostrarArchivos.php',
					type:'POST',
					data:'cara=1&id='+$('#codigos').html()+'&seller='+$('#competencia option:selected').html()+"_"+$('#unidades').val(),
