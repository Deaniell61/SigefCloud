...
session_start();
	...
	$squer="select orderid, timoford, (grandtotal), orderunits, ordsou, tranum,shicar from tra_ord_enc where (timoford between '".$inicio."-01 00:00:00' and '".$final."-30 23:59:59') and codprov='".$_SESSION['codprov']."' and shipstate='".$estado."' order by timoford desc";
