...
$pais=$_SESSION['pais'];
   ...
   $objPHPExcel->
    getProperties()
        ...
        ->setTitle("ProductosPorCantidad")
        ->setSubject("ProductosPorCantidad")
        ->setDescription("Productos Por Cantidad")
...
$objPHPExcel->getSheetCount();//cuenta las pestañas
	...
	if($_SESSION['codEmpresa']=="_4jt03skyy")
	{
		$objPHPExcel->setActiveSheetIndex($o)
            ->setCellValue('A'.$i, $lang[ $idioma ]['ItemCode'])
			->setCellValue('B'.$i, $lang[ $idioma ]['Descripcion'])
...
header('Content-Disposition: attachment;filename="Productos_Qty.xlsx"');
