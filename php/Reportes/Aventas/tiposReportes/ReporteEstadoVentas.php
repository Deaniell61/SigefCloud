...
$pais=$_SESSION['pais'];
   ...
   $objPHPExcel->
    getProperties()
        ...
        ->setTitle("EstadosPorVenta")
        ->setSubject("EstadosPorVenta")
        ->setDescription("Estados Por Venta")
   ...
   /*$objPHPExcel->setActiveSheetIndex($o)
	...
	$objPHPExcel->getActiveSheet()->setSharedStyle($estiloInformacion, "A4:A".($i-1));
	 ...
	 $objPHPExcel->getActiveSheet() ->getStyle('D4:'.$Letra2.$i) ->getNumberFormat() ->setFormatCode( '_-$* #,##0.00_-;-$* #,##0.00_-;_-$* "-"??_-;_-@_-' ); 
	  ...
	  //$objPHPExcel->getActiveSheet()->setSharedStyle($estiloInformacion, ($Letra1).($i));
...
header('Content-Disposition: attachment;filename="Estado_$.xlsx"');
