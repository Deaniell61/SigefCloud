...
$oculta="";
	...
	$retornar="
	 <img src=\"../images/excel.png\" id=\"exportExcel\" onClick=\"llamarReporte(14,document.getElementById('periIni'))\" style=\"width:20px;height:20px;float:right;margin-left:5px;margin-top:5px;margin-right: 20px;cursor:pointer;\">
	<center>
			<div><br>
