 ...
 if ($registros > 0) 
{
   ...
   $objPHPExcel->getActiveSheet()->getStyle('A2:AD2')->applyFromArray($estiloTituloColumnas);
...
header('Content-Disposition: attachment;filename="Bundles_Canal.xlsx"');
