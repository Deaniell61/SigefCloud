...
?>
            ...
            <center><div class=""><input type="button"   class='cmd button button-highlight button-pill' value="<?php echo $lang[ $idioma ]['Salir']; ?>" onClick="window.location.href='inicio.php'"/></div></center>
        </div>
