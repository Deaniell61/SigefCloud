      ...
      <br>
        <table>
        	...
        	<tr>
                ...
                <td class="colo1"><input type="text" class='entradaTexto' id="concern" placeholder="<?php echo $lang[$idioma]['Concerns'];?>"></td>
                
            </tr>
            <tr>

            <td colspan="2">
            <input type="button"  class='cmd button button-highlight button-pill'  onClick="guardarExtra('concerns','<?php echo $codigoEmpresa;?>',document.getElementById('concern').value,'','','','<?php echo $pais;?>','');actualizarExtras();" value="<?php echo $lang[$idioma]['Guardar'];?>"/>
